Pod::Spec.new do |spec|
  ...
  spec.name         = "MMAVPlayerWithGoogleDAI"
  spec.version      = "1.0.11"
  ...
  spec.homepage     = "https://github.com/MediamelonSDK/MMAVPlayerWithGoogleDAI"
  spec.license      = { :type => 'MIT', :file => 'LICENSE' }
  spec.author       = { "MediaMelon Engineer" => "engg@mediamelon.com" }
  spec.ios.deployment_target = "13.0"
  spec.swift_version = '5.0'
  spec.source       = { :git => "https://github.com/MediamelonSDK/MMAVPlayerWithGoogleDAI.git", :tag => spec.version.to_s }
